...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        //   the POV of the parent window). See 'Demo->Querying Status (Edited/Active/Hovered etc.)' for details.
        {
            ...
            ImGui::PushStyleColor(ImGuiCol_ChildBg, IM_COL32(15, 70, 255, 100));
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            }
            {
                ...
                ImU32 col_b = ImGui::GetColorU32(IM_COL32(15, 70, 255, 255));
                draw_list->AddRectFilledMultiColor(p0, p1, col_a, col_b, col_b, col_a);
            ...
            draw_list->AddRectFilledMultiColor(ImVec2(x, y), ImVec2(x + sz, y + sz), IM_COL32(0, 0, 0, 255), IM_COL32(15, 70, 255, 255), IM_COL32(255, 255, 0, 255), IM_COL32(0, 255, 0, 255));
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists"))
        {
            ...
            if (draw_bg)
                ImGui::GetBackgroundDrawList()->AddCircle(window_center, window_size.x * 0.6f, IM_COL32(15, 70, 255, 200), 0, 10 + 4);
            if (draw_fg)
