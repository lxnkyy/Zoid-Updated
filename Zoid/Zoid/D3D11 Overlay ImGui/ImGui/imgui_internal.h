...
//#endif
    ...
    IMGUI_API bool          ButtonInfo(const char* label, const char* label_1, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
	IMGUI_API bool			TachBar(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          TachRoll(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
