...
void ImGui::TableUpdateBorders(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        //GetForegroundDrawList()->AddRect(hit_rect.Min, hit_rect.Max, IM_COL32(15, 70, 255, 100));
...
#if 0
                GetOverlayDrawList()->AddRect(merge_group->ClipRect.Min, merge_group->ClipRect.Max, IM_COL32(15, 70, 255, 200), 0.0f, 0, 1.0f);
...
void ImGui::TableHeader(const char* label)
{
    ...
    //GetForegroundDrawList()->AddRect(cell_r.Min, cell_r.Max, IM_COL32(15, 70, 255, 255)); // [DEBUG]
    //GetForegroundDrawList()->AddRect(bb.Min, bb.Max, IM_COL32(15, 70, 255, 255)); // [DEBUG]
